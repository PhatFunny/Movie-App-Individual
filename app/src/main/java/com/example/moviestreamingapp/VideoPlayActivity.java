...
import com.example.moviestreamingapp.Adapters.ExtraVideosRecyclerAdapter;
import com.example.moviestreamingapp.Model.MovieVideosResults;
import com.example.moviestreamingapp.Utils.FullScreenHelper;
        ...
        if(intent != null && intent.getExtras() != null)
        {
            ...
            if(movieVideosResultsArrayList != null && movieVideosResultsArrayList.size() > 0)
            {
                ...
                if(videoId != null)
                {
                    ...
                    //load other video in recycler view
                    ...
                    if(movieVideosResultsList.size() > 0)
                    {
                        ...
                        //create animation for the loading items
