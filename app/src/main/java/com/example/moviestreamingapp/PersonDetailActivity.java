...
import com.example.moviestreamingapp.Adapters.PersonProfileImagesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(intent != null && intent.getExtras() != null)
        {
            ...
            if(intent.getExtras().getString("id") != null)
            {
                ...
                Call<PersonDetails> personDetailsCall = retrofitService.getPersonDetailsByQuery(id, BuildConfig.THE_MOVIE_DB_API_KEY);
